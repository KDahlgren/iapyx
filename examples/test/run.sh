...
cmd="time python ../../src/drivers/iapyx.py -c 0 -n a,b,c --EOT 4 -f ./simplog.ded --evaluator c4 --settings ./settings.ini"
#cmd="time python ../../src/drivers/iapyx.py -n a,b,c --EOT 4 -f ./simplog.ded --evaluator c4"
opt_cmd="cmd"
